...
const LivePage = () => {
  ...
  const handleCameraClick = (camera) => {
    ...
    axios
    .post(`http://localhost:30080/vst/api/v1/live/stream/start`, sessionDescriptionPayload)
    .then((response) => {
